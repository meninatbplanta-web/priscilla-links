        ...
        <section className="relative bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white pt-12 pb-20 px-4 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div className="text-center md:text-left space-y-6 order-2 md:order-1">
                    <div className="inline-block px-4 py-1 rounded-full bg-green-600/20 border border-green-500/50 text-green-400 text-sm font-semibold mb-2">
                        ✅ Inscrição na Formação Confirmada com Sucesso!
                    </div>
                    <h1 className="text-3xl md:text-5xl lg:text-5xl font-black leading-tight">
                        ESPERE! <span className="text-red-500">NÃO FECHE ESSA PAGINA</span>
                    </h1>
                    <p className="text-xl text-gray-200 font-medium">
                        Você acabou de dar um grande passo na sua carreira. Mas antes de ir para a área de membros, tenho um convite exclusivo para você.
                    </p>

                    <div className="space-y-2 text-gray-300">
                        <h3 className="text-xl font-bold text-white mb-2">Grupo Terapêutico para Terapeutas</h3>
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed max-w-xl mx-auto md:mx-0 pt-4 border-t border-gray-700">
                        Um espaço de escuta, troca e aprofundamento emocional criado especialmente para quem cuida de outros — e muitas vezes esquece de cuidar de si. <strong className="text-white">Complemente sua formação com vivência prática e suporte emocional.</strong>
                    </p>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-4 text-sm text-gray-400 pt-2">
                        <div className="flex items-center gap-1">
                            <Lock className="w-4 h-4" /> Oferta Exclusiva de Upsell
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-3xl font-bold text-gray-900">
                            Por que entrar para o Grupo Terapêutico agora?
                        </h2>
                        <p className="text-gray-600 leading-relaxed text-lg">
                            Na Formação Analista, você vai aprender a técnica e a teoria. No Grupo Terapêutico, você vai **vivenciar** o cuidado e trabalhar suas próprias questões.
                        </p>
                        <p className="text-gray-600 leading-relaxed text-lg">
                            É a combinação perfeita: conhecimento técnico + suporte emocional. Terapeutas bem cuidados atendem melhor e prosperam mais.
                        </p>
                    </div>
            ...
            <div className="max-w-lg mx-auto">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                    <div className="bg-gray-900 p-6 text-center text-white">
                        <h3 className="text-2xl font-bold">Oferta Exclusiva de Upsell</h3>
                        <p className="text-gray-400 mt-2">Aproveite sua inscrição e entre com desconto</p>
                    </div>
                    ...
                    <div className="p-8 text-center space-y-6">
                        ...
                        <Button href={CHECKOUT_LINK} className="w-full animate-pulse">
                            SIM, QUERO ADICIONAR E ENTRAR NO GRUPO
                        </Button>

                        <a href="https://priscilla-moreira.com/area-membros" className="block text-gray-400 text-sm hover:underline mt-4">
                            Não, obrigado. Quero apenas acessar minha formação.
                        </a>
